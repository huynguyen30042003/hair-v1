    ...
    <Layout>
      <div className="container mx-auto p-4">
        <div className="flex justify-between items-center mb-4">
          <Typography variant="h1">Quản lý nhân viên</Typography>
            ...
            <table className="min-w-full bg-white">
              <thead>
                <tr>
                  ...
                  <th className="w-1/4 px-4 py-2">Chức vụ</th>
        ...
        <Dialog open={openDialog} handler={setOpenDialog}>
          <DialogHeader>{isEditing ? 'Chỉnh sửa nhân viên' : 'Thêm nhân viên'}</DialogHeader>
          <DialogBody divider>
